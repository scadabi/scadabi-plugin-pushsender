...
public class PushPlugin extends CordovaPlugin implements PushConstants {
	...
	private static String SENDER_APPLICATION_VALUE = "new";
	private static String SENDER_GROUP_VALUE = "new";
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) {
        ...
        if (INITIALIZE.equals(action)) {
            ...
            try {
				...
				//Get Parameters News
				this.setSenderAppValue(jo.getString(SENDER_APPLICATION));
				this.setSenderGroupValue(jo.getString(SENDER_GROUP));
            ...
            if (jo != null) {
                SharedPreferences sharedPref = getApplicationContext().getSharedPreferences(MX_COM_SCADABI_PUSHSENDER, Context.MODE_PRIVATE);
	...
	public static String getSenderAppValue()
	{
		return SENDER_APPLICATION_VALUE;
	}
	public static String getSenderGroupValue()
	{
		return SENDER_GROUP_VALUE;
	}
	
	public static void setSenderAppValue(String data)
	{
		SENDER_APPLICATION_VALUE = data;
	}
	public static void setSenderGroupValue(String data)
	{
		SENDER_GROUP_VALUE = data;
	}
    ...
    public void onPause(boolean multitasking) {
        ...
        SharedPreferences prefs = getApplicationContext().getSharedPreferences(MX_COM_SCADABI_PUSHSENDER, Context.MODE_PRIVATE);
    ...
    private static JSONObject convertBundleToJson(Bundle extras) {
        try {
            ...
            while (it.hasNext()) {
                ...
                }else if (key.equals(MESSAGE_INFORMATION)) {
                    json.put(MESSAGE_INFORMATION, value);
